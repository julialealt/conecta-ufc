    ...
    isLoading ? (
      ...
      <div className="w-full self-stretch px-30 pt-6 pb-16 bg-zinc-950 inline-flex flex-col justify-start items-start gap-16">
        <div className="self-stretch w-full inline-flex justify-start items-start gap-6">
          <Avatar imageUrl={userData?.profileImage} name={userData?.name || ""} variant="person" size="lg" />
          ...
          {params.id === userId && <Button variant="outline_violet" Icon={Pen} size="icon" onClick={() => router.push(`/student/${userId}/update`)} />}
        </div>
        ...
        <div className="w-full inline-flex flex-col justify-start items-start gap-12">
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            <div className="w-full justify-start text-zinc-300 text-base font-medium leading-[150%]">{userData?.description}</div>
          </div>
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            <div className="w-full inline-flex justify-start items-start gap-8">
              <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
                ...
                <div className="self-stretch justify-start text-zinc-300 text-base font-medium leading-[150%]">{userData?.course}</div>
              </div>
              <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
                <div className="self-stretch justify-start text-white text-lg font-semibold leading-[150%]">Semestre de ingresso</div>
                <div className="self-stretch justify-start text-zinc-300 text-base font-medium leading-[150%]">{userData?.entrySemester}</div>
              </div>
              <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
                <div className="self-stretch justify-start text-white text-lg font-semibold leading-[150%]">Previsão de término</div>
                <div className="self-stretch justify-start text-zinc-300 text-base font-medium leading-[150%]">{userData?.graduationForecast}</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            {userData?.experiences && userData.experiences.length > 0 ? (
              userData.experiences.map((experience) => (
                <div key={experience._id} className="flex flex-col justify-start items-start gap-2">
                  <div className="self-stretch inline-flex justify-start items-center gap-1">
                    <div className="justify-start text-violet-500 text-lg font-semibold leading-[150%]">{experience.title} - {experience.company}</div>
                    <ProfessionalExpDialog
                      type="edit"
                      title=""
                      onChangeTitle={() => { }}
                  ...
                  <div className="w-full justify-start text-white text-base font-semibold leading-[150%] italic">{experience.startDate} - {experience.endDate}</div>
                  <div className="w-full justify-start text-zinc-300 text-base font-medium leading-[150%]">{experience.description}</div>
                </div>
              ))
            ) : (
            ...
            <div className="self-stretch inline-flex justify-start items-start gap-2 flex-wrap content-start">
              {userData?.skills && userData?.skills.length > 0 ? (
                userData?.skills.map((skill, index) => (
                  <Button key={index} variant="ghost">{skill}</Button>
                ))
              ) : (
                <div className="pt-5 w-full justify-start text-zinc-400 text-sm leading-[150%]">
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            {userData?.projects && userData?.projects.length > 0 ? (
              userData?.projects.map((project) => (
                <div key={project._id} className="inline-flex flex-col justify-start items-start gap-2">
                  <div className="self-stretch inline-flex justify-start items-center gap-1">
                    <div className="justify-start text-white text-lg font-semibold leading-[150%]">{project.name}</div>
                    <ProjectDialog
                      type="edit"
                      title=""
                      onChangeTitle={() => { }}
                  ...
                  <div className="w-full justify-start text-zinc-300 text-base font-medium leading-[150%]">{project.description}</div>
                  <div className="self-stretch inline-flex justify-start items-center gap-2">
                    <div className="justify-start text-zinc-500 text-sm font-medium leading-[150%]">{project.type}</div>
                    <div className="justify-start text-violet-500 text-sm font-medium leading-[150%]">{project.link}</div>
                  </div>
                </div>
              ))
            ) : (
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            {userData?.articles && userData?.articles.length > 0 ? (
              userData?.articles.map((article) => (
                <div key={article._id} className="inline-flex flex-col justify-start items-start gap-2">
                  <div className="self-stretch inline-flex justify-start items-center gap-1">
                    <div className="justify-start text-white text-lg font-semibold leading-[150%]">{article.title}</div>
                    <ArticleDialog
                      type="edit"
                      title=""
                      onChangeTitle={() => { }}
                  ...
                  <div className="w-full justify-start text-zinc-300 text-base font-medium leading-[150%]">{article.summary}</div>
                  <div className="self-stretch inline-flex justify-start items-center gap-2">
                    <div className="justify-start text-zinc-500 text-sm font-medium leading-[150%]">Artigo publicado</div>
                    <div className="justify-start text-violet-500 text-sm font-medium leading-[150%]">{article.url}</div>
                  </div>
                </div>
              ))
            ) : (
          ...
          <div className="w-full pt-8 border-t border-zinc-500 inline-flex flex-col justify-start items-start gap-4">
            ...
            {userData?.certificates && userData?.certificates.length > 0 ? (
              userData?.certificates.map((certificate) => (
                <div key={certificate._id} className="self-stretch inline-flex justify-start items-start gap-4">
                  <Avatar variant="organization" name={certificate.organization} size="md" />
                  <div className="self-stretch inline-flex flex-col justify-start items-start">
                    <div className="self-stretch inline-flex justify-start items-center gap-1">
                      <div className="justify-start text-white text-lg font-semibold leading-[150%]">{certificate.title}</div>
                      <CertificateDialog
                        type="edit"
                        title=""
                        onChangeTitle={() => { }}
                    ...
                    <div className="self-stretch inline-flex justify-start items-start gap-2">
                      <div className="justify-start text-zinc-300 text-sm font-medium leading-[150%]">{certificate.organization}</div>
                      <div className="justify-start text-zinc-300 text-sm font-medium leading-[150%]">•</div>
                      <div className="justify-start text-zinc-300 text-sm font-medium leading-[150%]">{certificate.issuedAt.getFullYear()}</div>
                    </div>
