  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="justify-start text-violet-500 text-xs font-medium leading-[150%] cursor-pointer">Informações de contato</div>
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="self-stretch inline-flex flex-col justify-start items-start gap-4">
          <div className="inline-flex flex-col justify-start items-start gap-1.5">
            <div className="w-96 justify-start text-violet-50 text-sm font-semibold leading-[150%]">E-mail</div>
            <div className="w-96 justify-start text-violet-50 text-xs font-normal leading-[150%]">{email}</div>
          </div>
          <div className="flex flex-col justify-start items-start gap-1.5">
            <div className="w-96 justify-start text-violet-50 text-sm font-semibold leading-[150%]">Links</div>
            <div className="flex flex-col justify-start items-start gap-2">
              {links.map(link => (
                <div key={link.url} className="w-96 h-3.5 inline-flex justify-start items-center gap-1">
                  <Button variant="link" size="small" className="p-0 font-semibold">{link.url}</Button>
                  <div className="justify-start text-zinc-400 text-xs font-normal leading-[150%]">({link.label})</div>
                </div>
              ))}
            </div>
          </div>
          <div className="flex flex-col justify-start items-start gap-1.5">
            <div className="w-96 justify-start text-violet-50 text-sm font-semibold leading-[150%]">Data de nascimento</div>
            <div className="w-96 justify-start text-violet-50 text-xs font-normal leading-[150%]">{birthDate}</div>
          </div>
        </div>
        <DialogClose asChild>
